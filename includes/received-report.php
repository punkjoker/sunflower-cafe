    ...
    <div class="col-md-12">
      ...
      <div class="card">
        <div class="card-header">
          <div class="row">
            <div class="col-md-6">
              <h4 class="card-title">Paid M-PESA Report</h4>
            </div>
        ...
        <div class="card-body" id="printable">
          <h5 align="center" style="color:blue">Paid M-PESA <?php echo ucfirst($rtype); ?> Report from <span style="color:red"><?php echo $fdate ?></span> to <span style="color:red"><?php echo $tdate ?></span></h5>
          <hr />
          <?php
          $userid=$_SESSION['detsuid'];
          $ret=mysqli_query($db,"SELECT name,date_of_lending,status,description,SUM(amount) as totaldaily FROM `lending`  where (date_of_lending BETWEEN '$fdate' and '$tdate') && (UserId='$userid') && (status = 'received') group by name, date_of_lending");
            ...
            <tbody>
              ...
              <tr>
                ...
                <td><?php  if ($row["status"] == "received") {
                 echo '</i> <span class="badge bg-success text-white">Paid M-PESA</span>';
                } else {
