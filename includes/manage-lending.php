                                        ...
                                        ?>
                                          ...
                                          <div class="dropdown">
                                            ...
                                            <div class="dropdown-menu" aria-labelledby="dropdownMenuButton<?php echo $row['id']; ?>">
                                              ...
                                              <a class="dropdown-item" href="mpesa-checkout.php"><i class="fas fa-cash-register"></i> Checkout Expense</a>
                                            </div>
                                          </div>
                                            ...
                                            <div class="modal-content">
                                                ...
                                                <div class="modal-body">
                                                    <form action="update-lending.php" method="POST">
                                                        ...
                                                        <div class="form-group">
                                                            <label for="edit-expense-date">Date of Sales:</label>
                                                        ...
                                                        <div class="form-group">
                                                            <label for="edit-expense-amount">Total Amount:</label>
